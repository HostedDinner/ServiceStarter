...
${OBJECTDIR}/src/ConfigParser.o: src/ConfigParser.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -D_WIN32_WINNT=0x0600 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConfigParser.o src/ConfigParser.cpp

${OBJECTDIR}/src/NotificationIconController.o: src/NotificationIconController.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -D_WIN32_WINNT=0x0600 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/NotificationIconController.o src/NotificationIconController.cpp

${OBJECTDIR}/src/ScrollBarController.o: src/ScrollBarController.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -D_WIN32_WINNT=0x0600 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ScrollBarController.o src/ScrollBarController.cpp
...
${OBJECTDIR}/src/tinyxml2/tinyxml2.o: src/tinyxml2/tinyxml2.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -D_WIN32_WINNT=0x0600 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tinyxml2/tinyxml2.o src/tinyxml2/tinyxml2.cpp
